...
struct qt_meta_stringdata_QwtCompass_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QwtCompass_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QwtCompass_t qt_meta_stringdata_QwtCompass = {
    {
QT_MOC_LITERAL(0, 0, 10) // "QwtCompass"
...
const QMetaObject QwtCompass::staticMetaObject = {
    { &QwtDial::staticMetaObject, qt_meta_stringdata_QwtCompass.data,
      qt_meta_data_QwtCompass,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QwtCompass::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QwtCompass.stringdata0))
