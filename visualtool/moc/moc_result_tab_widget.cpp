/****************************************************************************
** Meta object code from reading C++ file 'result_tab_widget.h'
**
...
#error "The header file 'result_tab_widget.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 16, 24), // "tabCloseRequestedHandler"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 5), // "index"
QT_MOC_LITERAL(4, 48, 29), // "loadEventtraceFinishedHandler"
QT_MOC_LITERAL(5, 78, 7) // "success"

    },
    "ResultTabWidget\0tabCloseRequestedHandler\0"
    "\0index\0loadEventtraceFinishedHandler\0"
    "success"
};
...
void ResultTabWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->tabCloseRequestedHandler((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->loadEventtraceFinishedHandler((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject ResultTabWidget::staticMetaObject = {
    { &QTabWidget::staticMetaObject, qt_meta_stringdata_ResultTabWidget.data,
      qt_meta_data_ResultTabWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
